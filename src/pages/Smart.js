    ...
    <div>
      <div className="container projFeatures">
        ...
        <Features24
          ...
          feature1ImgSrc={"./media/slider/img06.webp"}
          ...
          feature2ImgSrc={"./media/slider/img01.webp"}
          ...
          feature3ImgSrc={"./media/slider/img05.webp"}
        ></Features24>
      </div>
      ...
      <div className="container projFeatures">
        ...
        <div className="services02">
          {/* <Card>
          <img src="./media/slider/img06.webp" />
          <h2>Smart Points</h2>
          ...
          {/* <Card>
          <img src="./media/slider/img01.webp" />
          <h2>aXess</h2>
          ...
          {/* <Card>
          <img src="./media/slider/img05.webp" />
          <h2>ReflectV</h2>
          ...
          {/* <Card>
          <img src="./media/slider/img04.webp" />
          <h2>Elev8</h2>
          ...
          {/* <Card>
          <img src="./media/slider/img02.webp" />
          <h2>DesQ</h2>
          ...
          {/* <Card>
          <img src="./media/slider/img03.webp" />
          <h2>DigiServe</h2>
